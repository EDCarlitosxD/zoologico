...
import { IDataGraficsBar, BarChartComponent } from '../../Componentes/bar-chart/bar-chart.component';
...
@Component({
  ...
  standalone: true,
  imports: [DashboardContentComponent, NgFor, NgIf, NgClass, ChartCakeComponent, CargandoComponent, BarChartComponent],
